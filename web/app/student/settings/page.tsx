...
export default function StudentSettingsPage() {
    ...
    const fetchProfile = useCallback(async () => {
        try {
            const res = await authedFetch("/api/profile?intendedRole=student");
    ...
    return (
        <DashboardLayout role="student" title="Identity Settings">
            <div className="max-w-[1400px] mx-auto space-y-10 pb-20 px-4">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-slate-200 dark:border-white/5 pb-8 pt-4">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Identity Settings</h1>
                        <p className="text-sm text-slate-500 mt-1 font-medium">Manage your student profile and contact details.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <div className="p-2 space-y-1 bg-slate-50 dark:bg-slate-950/50 rounded-2xl border border-slate-100 dark:border-white/5">
                            <Button variant="ghost" className="w-full justify-start text-xs font-bold uppercase tracking-widest gap-3 h-11 bg-white dark:bg-slate-900 shadow-sm text-blue-600 rounded-xl">
                                <User className="w-4 h-4" /> Learner Profile
                            </Button>
                    ...
                    <div className="lg:col-span-9 space-y-10">
                        ...
                        <Card className="border-none shadow-xl bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-100 dark:border-white/5">
                            <CardHeader className="p-8 border-b border-slate-100 dark:border-white/5">
                                ...
                                <CardDescription className="text-xs font-medium">Keep your registration details up-to-date.</CardDescription>
                            </CardHeader>
                            <CardContent className="p-8 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {profile.school_id ? (
                                                <Badge variant="outline" className="h-11 px-4 rounded-xl border-slate-200 dark:border-white/10 text-[9px] font-bold tracking-widest text-emerald-600">LINKED</Badge>
                                            ) : (
                                ...
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Learning Objectives / Bio</Label>
                                ...
                                <div className="pt-4 flex justify-end">
                                    <Button onClick={handleSaveProfile} disabled={profileSaving} className="bg-blue-600 hover:bg-black dark:hover:bg-blue-700 text-white h-12 px-10 rounded-xl font-bold uppercase text-[10px] tracking-widest shadow-lg shadow-blue-500/10 gap-2">
